...
import { idgetPelotones, putPelotones } from "../Api/Pelotones";

function PagPelotones() {
          ...
          <>
            <form className="p-4 md:p-5 lg:p-6" onSubmit={onSubmit}>
              <div className="my-3 flex items-center px-3">
                ...
                <span className="mx-3 text-green-700">Pelotones</span>
                <hr className="w-full border-green-700" />
              </div>

              <div className="grid gap-y-3">
                <input
                  defaultValue={dataForm.nombreP}
                  onChange={onChange}
                  name="nombreP"
                ...
                />
                <input
                  defaultValue={dataForm.descripcionP}
                  onChange={onChange}
                  name="descripcionP"
                  className="focus:border-green-400 rounded-md border border-green-700 bg-transparent py-3 px-4 text-green-200 outline-none transition placeholder-text-green-400"
                  placeholder="Descripción del pelotón"
                />
                <input
                  defaultValue={dataForm.ubicacionP}
                  onChange={onChange}
                  name="ubicacionP"
                  className="focus:border-green-400 rounded-md border border-green-700 bg-transparent py-3 px-4 text-green-200 outline-none transition placeholder-text-green-400"
                  placeholder="Ubicación del pelotón"
                />
                <input
                  type="checkbox"
                  id="choose-me"
